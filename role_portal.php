...
<article class="panel"><div class="panel-head"><div><h2>My Documents</h2><p>Track, preview, download, and resubmit your files.</p></div><select id="documentFilter"><option value="">All statuses</option><optgroup label="Workflow"><option>Pending Adviser Review</option><option>Needs Revision</option><option>Ready for Formal RPMS Submission</option><option>Submitted to RPMS</option></optgroup><optgroup label="Review status"><option>Submitted</option><option>Under Review</option><option>Received</option><option>Verified</option><option>Resubmission Requested</option><option>Approved</option><option>Denied</option></optgroup></select></div><div class="document-table-wrap"><table><thead><tr><th>Document</th><th>Type</th><th>Submitted</th><th>Status</th><th>Remarks</th><th>Actions</th></tr></thead><tbody id="documentRows"></tbody></table></div></article>
</section>
